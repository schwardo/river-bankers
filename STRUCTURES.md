...
| Name | Effect |
|------|--------|
| **Otter Slide** | When you build, advance 1 less fish (min 1). |
| **Mill Wheel** | When you pass 0, your next action's fish cost is halved (round up). |
...
| **Otter Raft** | In a jammed auction, workers that didn't clinch refund half their fish (round down). |
...
| Name | Effect |
|------|--------|
| **Reed Bed** | Reed icons cost you 1 less fish per item (min 1). |
...
| **Wood Pile** | When you pass 0, claim 1 uncovered Log icon from any river card for 0🐟. |
...
| **Burrow Run** | Slide your pawn back 5 on the fish track. |
| **Snag Pile** | Pull a pre-river card to River 1 for free; an auction immediately runs on it at 0🐟/item. *(Your bid still costs at the new river rate.)* |
...
| **Sap Drip** | Place 2 free workers from your supply onto any uncovered icons on a single river card. No auction, no fish. |
