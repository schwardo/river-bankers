...
3. **Flush the Headwaters — 5🐟.** Discard all cards currently in the Headwaters (out of game). Refill from the top of the deck (revealing 3 fresh cards). Pick one of those new cards and run an auction on it at the Headwaters rate (1🐟/item); triggering this auction is *free* — the 5🐟 already paid covers it — but you still pay for your own bid normally and **must bid at least one worker** on it. The other two newly-revealed Headwaters cards stay in their slots. After the auction settles, the auctioned card's slot refills as usual. If the deck has fewer than 3 cards left when you flush, the Headwaters refills with whatever's available. **You can't flush once the material deck is empty** — without fresh cards to draw, the action is illegal.
