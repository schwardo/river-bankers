...
End of game: +3 VP per built structure of yours that uses Mud (max +9).'],
    ...
    public static array $STARTER = [
        ...
        7 => ['name' => 'Channel Clearer', 'species' => 'muskrat', 'vp' => 0, 'effect' => 'At the start of your turn, you may pay 1 fish to discard 1 worker from any Reeds river card (not a wild card); it returns to that player\'s supply without a blank.'],
