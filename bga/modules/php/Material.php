...
End of game: +3 VP per built structure of yours that uses Mud (max +9).'],
    ...
    public static array $STARTER = [
        ...
        7 => ['name' => 'Channel Clearer', 'species' => 'muskrat', 'vp' => 0, 'effect' => 'At the start of your turn, you may discard 1 Reed worker from any river card; returns to that player\'s supply without a blank.'],
