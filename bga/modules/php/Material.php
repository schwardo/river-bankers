...
class Material
{
    ...
    public static array $MATERIAL = [
        ...
        25 => ['name' => 'Flotsam Raft', 'material' => 'staging', 'icons' => 6, 'effect' => 'Cannot be spent. As an action, move workers to open river icons (drop a blank): slide back this card\'s cost, advance the destination\'s. Never enters shoreline.'],
    ];
    ...
    public static array $STRUCTURE = [
        ...
        12 => ['name' => 'Cattail Marsh', 'cost' => ['reeds' => 4, 'mud' => 2], 'time' => 3, 'vp' => '5', 'effect' => 'When you build another structure: each Reed worker counts as 2 reeds.'],
...
End of game: +3 VP per built structure of yours that uses Mud (max +9).'],
        ...
        39 => ['name' => 'Tribute Stone', 'cost' => ['clay' => 2, 'stones' => 2], 'time' => 3, 'vp' => '5', 'effect' => 'Once per game (flip card): force an opponent to recall one of their workers from a river card (drops a blank). They slide back that card\'s per-item cost in 🐟 as compensation.'],
        ...
        41 => ['name' => 'Portage', 'cost' => ['vines' => 3, 'stones' => 2], 'time' => 3, 'vp' => '6', 'effect' => 'As an action: swap one of your workers on a river card with another player\'s worker on a different river card. Pay the source card\'s per-item cost in 🐟. They slide back 2🐟 in compensation.'],
        42 => ['name' => 'Salmon Run', 'cost' => ['logs' => 4, 'vines' => 2], 'time' => 4, 'vp' => '6', 'effect' => 'Once per game (flip card): place 1-5 workers from your supply onto uncovered icons of one river card. Total 🐟 cost 1/2/3/5/8.'],
    ...
    public static array $STARTER = [
        ...
        11 => ['name' => 'Snare Set', 'species' => 'mink', 'vp' => 1, 'effect' => 'Once per game, force an opponent to recall one of their workers from a river card (drops a blank). The opponent slides back the card\'s per-item cost in fish as compensation.'],
    ];
}
