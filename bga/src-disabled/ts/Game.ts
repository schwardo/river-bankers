...
export class Game {
    public bga: Bga<RiverBankersPlayer, RiverBankersGamedatas>;
    private gamedatas: RiverBankersGamedatas;

    private playerTurn: PlayerTurn;

    constructor(bga: Bga<RiverBankersPlayer, RiverBankersGamedatas>) {
    ...
    */
    ...
    setup(gamedatas: RiverBankersGamedatas) {
